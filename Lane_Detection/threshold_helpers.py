...
'''
calcule o limiar de x ou y sobel dado determinados tamanhos de thresh e kernel
'''
...
'''
calcular a magnitude do gradiente, dada uma imagem e um limiar
'''
...
'''
Calcule a direção do gradiente dado uma imagem e um valor thresh
'''
...
'''
calcular o limiar dos valores de hls
'''
...
'''
Combinação das funções de thresholders
'''
...
'''
dado um diretório, retornar uma matriz de todas as imagens nele
'''
...
'''
para cada imagem no array, imprima
'''
...
'''
Execute a função thresholding em cada imagem para que possa ver como ela funciona em todosl
'''
